...
int main() 
{
	...
	vector<double> Co1, Co2, Cu1, Cu2, ins1;//TODO recent addition (22-5-19) ins is pps+0.05 for 1st neighbour in Cu, so onsite and second nn are for Cu
	...
	Co_u = U(1,1);
	Cu = U(2,0);
	ins0 = Cu + 0.22*I;//TODO 22-5-19 this shift places the fermi level in the artificial HG
	...
	// set bias
	/* double V = 0.0; */
	double V = 0.065;//TODO 23-5-19 bandgap is approx - fake Cu + 0.22 - fake Cu + 0.155
