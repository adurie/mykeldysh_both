...
//    dee=2.1         //   approximately reproduces Yuassas results
      ...
      //Cu
              s0 =  0.79466 - Cu_ef;
              p0 =  1.35351 - Cu_ef;
              d0t =  0.5*(0.37307 + 0.37180) - Cu_ef;
              d0e =  0.5*(0.37307 + 0.37180) - Cu_ef;
      }
      ...
      //BULK Co up:
      	      s0 =  1.12946 - ef;
       	      p0 =  1.75262 - ef;
              d0t =  0.5*(0.60547 + 0.60445) - ef + vex;
              d0e =  0.5*(0.60547 + 0.60445) - ef + vex;
	}
	else if (spin == 1){
      //BULK Co down:
      	      s0 =  1.12946 - ef;
      ...
      /* else if (numat == 3){ */
      /* //Cu */
      /*         s0 =  0.79466 - Cu_ef - ins_shift; */
      /*         p0 =  1.35351 - Cu_ef - ins_shift; */
      /*         d0t =  0.5*(0.37307 + 0.37180) - Cu_ef - ins_shift; */
      /*         d0e =  0.5*(0.37307 + 0.37180) - Cu_ef - ins_shift; */
      /* } */
      //Li with Mg params - Li, Mg are +2 cation
      else if (numat == 3){	
      ...
      //Cl with O params - Cl, O are -2 anion
      else if (numat == 4){
	      s0 = 100. + xmgo_shift;
